      ...
      <Stack spacing={{ xs: 2, md: 4 }} justifyContent="center">
        <Stack spacing={4}>
          <Stack spacing={2}>
            ...
            <Typography gutterBottom>By supporting EU Member States in deploying a set of harmonised European public data standards (<a href="https://data4pt.org/w/index.php?title=Transmodel" target="_blank" rel="noreferrer">Transmodel</a>, <a href="https://data4pt.org/w/index.php?title=NeTEX" target="_blank" rel="noreferrer">NeTEx</a> and <a href="https://data4pt.org/w/index.php?title=SIRI" target="_blank" rel="noreferrer">SIRI</a>), DATA4PT wants to enable union-wide multimodal travel information services and contribute to a seamless door-to-door travel ecosystem across Europe that covers all mobility services.</Typography>
          </Stack>
          <Stack spacing={2}>
            <Typography variant="h3">Validation tool</Typography>
            <Typography>
              Key activity of DATA4PT project is the development of validation tools for <a href="https://data4pt.org/w/index.php?title=NeTEX" target="_blank" rel="noreferrer">NeTEx</a> and <a href="https://data4pt.org/w/index.php?title=SIRI" target="_blank" rel="noreferrer">SIRI</a> datasets. As <a href="https://data4pt.org/w/index.php?title=NeTEX" target="_blank" rel="noreferrer">NeTEx</a> and <a href="https://data4pt.org/w/index.php?title=SIRI" target="_blank" rel="noreferrer">SIRI</a> are the EU standardised formats for public transport data in National Access Points (NAPs), the purpose of validation is to ensure a certain level of quality of the published data. The quality dimension is aligned with the overall objective of the project to enable the implementation of ITS Directive Delegated Regulation EU 2017/1926 and therefore the interoperable exchange of travel and traffic data across Europe.
            </Typography>
            <Typography>
